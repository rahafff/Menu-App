    ...
    return Container(
      ...
      child: Padding(
        ...
        child: TextFormField(
          ...
          onEditingComplete: widget.maxLines!=null ? null : () => node.nextFocus(),
          onFieldSubmitted: widget.maxLines!=null ? (_) => node.unfocus() : null,
          textInputAction: widget.maxLines!=null ? null : TextInputAction.next,
          inputFormatters:widget.numbers ? <TextInputFormatter>[
