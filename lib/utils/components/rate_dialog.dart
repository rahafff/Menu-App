...
import 'package:rightware/utils/effect/hidder.dart';
class RatingAlertDialog extends StatelessWidget {
  final Function(double) onPressed;
  final String title;
  final String message;
  final String? image;
  RatingAlertDialog({required this.onPressed,required this.message,required this.title,this.image});
  @override
                ...
                Hider(
                  ...
                  child: Padding(
                    ...
                    child: ClipRRect(
                        ...
                        child: CustomNetworkImage(height:100, width: 100, imageSource:image!)),
                  ),
                ),
                RatingBar.builder(
                  initialRating:0,
